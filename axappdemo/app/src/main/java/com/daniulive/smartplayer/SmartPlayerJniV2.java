...
public class SmartPlayerJniV2 {
     ...
     *
     * @param handle:         return value from SmartPlayerOpen()
     * @param use_audiotrack: <pre> NOTE: if use_audiotrack with 0: it will use auto-select output devices; if with 1: will use audio-track mode. </pre>
     * @return {0} if successful
     */
     ...
     *
     * @param handle: return value from SmartPlayerOpen()
     * @param buffer: <pre> NOTE: Unit is millisecond, range is 0-5000 ms </pre>
     * @return {0} if successful
     */
